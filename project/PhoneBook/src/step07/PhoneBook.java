...
// copy해오면서 다른 package를 import할 수도 있음
...
//		System.out.println("----------------------------------------");
	...
	public static void main(String[] args)
	{
		...
		while(true)
		{
			readInfo();		//프로그램 실행할 때 정보를 가져오는게 낫다
			showMenu();
			choice = sc.nextInt();
			sc.nextLine();
			switch (choice)
...
//step06에서 만들어진 PhoneBook.bin을 먼저 삭제하고 실행해야 에러가 나지 않는다.
//삭제하고 처음 실행했을 때는 readInfo()때문에 오류날 수 있다.
//에러를 보기 싫으면 readInfo()의 IOException을 주석처리하고 실행하면 된다.

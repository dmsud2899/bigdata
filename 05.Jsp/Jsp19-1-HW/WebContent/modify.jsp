...
<script>
//셀렉트의 옵션값 자바스크립트로 체크해서 설정하기
	//var cnt = document.fm.phone1.options.length;
	//console.log("cnt" + cnt);
	//for(var i=0; i<cnt; i++)
	//{
	//	if (document.fm.phone1.options[i].value == "<%=phone1%> ")
	//	{
	//		document.fm.phone1.options[i].selected = true;
	//		break;
	//	}
	//}
